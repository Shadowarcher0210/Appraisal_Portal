...
const App = () => {
  ...
  // Define a condition to hide header and navbar for specific paths
  ...
  return (
    <div className="flex">
      {/* Show Leftnavbar only if hideNavAndHeader is false */}
      {!hideNavAndHeader && <Leftnavbar />}
      
      <div className="flex-grow">
        {/* Show Header only if hideNavAndHeader is false */}
