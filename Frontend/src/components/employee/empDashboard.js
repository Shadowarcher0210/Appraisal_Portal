        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="px-6 py-3 text-center text-xs font-medium text-gray-700 uppercase tracking-wider">Assessment Year</th>
              <th className="px-6 py-3 text-center text-xs font-medium text-gray-700 uppercase tracking-wider">Initiated On</th>
              <th className="px-6 py-3 text-center text-xs font-medium text-gray-700 uppercase tracking-wider">Manager name</th>
            ...
            {userData ? (
              userData.map((appraisal, index) => (
                <tr key={index}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500 text-center">{appraisal.managerName}</td>
