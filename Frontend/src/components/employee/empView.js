      ...
      <div className="flex-1 p-8 ml-44">
        ...
        {activeTab === 0 && (
            <div className="relative h-full flex flex-col">
              <h1 className=' font-bold text-center text-4xl text-cyan-500'>Introduction</h1>
              <p className='font-bold text-2xl mt-4'>Instructions, steps, and FAQs related to the appraisal process.</p>
              <ul>
              ...
              <h1 className=' font-semibold text-pink-500 text-3xl mt-4'>Important Instructions</h1>
              <ul>
              ...
              {selfAppraisalPage === 1 && (
                ...
                <div className="mt-4 flex-1 overflow-y-auto">
                  ...
                  <div className="border rounded-lg shadow-lg p-4 mb-4 bg-white">
                    ...
                    <p>In response to the fluctuating demands of my job, I adapt easily to plans, goals, actions, and priorities.</p>
                    <textarea
                      className="w-full h-24 border border-gray-300 rounded p-2 mt-2 resize-none "
                      placeholder="Type your answer here..."
                    ></textarea>
                  ...
                  <div className="border rounded-lg shadow-lg p-4 mb-4 bg-white">
                    ...
                    <p>I Convey my thoughts clearly and respectfully.</p>
                    <textarea
                      className="w-full h-24 border border-gray-300 rounded p-2 mt-2 resize-none "
                      placeholder="Type your answer here..."
                    ></textarea>
                  ...
                  <div className="border rounded-lg shadow-lg p-4 mb-4 bg-white">
                    {/* <h2 className="font-semibold mb-2">Communication</h2> */}
                    <p>I demonstrate effective listening skills.
                    </p>
                    <textarea
                      className="w-full h-24 border border-gray-300 rounded p-2 mt-2 resize-none "
                      placeholder="Type your answer here..."
                  ...
                  <div className="border rounded-lg shadow-lg p-4 mb-4 bg-white">
                    ...
                    <p>I identify goals that are aligned with the organization’s strategic direction and achieve results accordingly.</p>
                    <textarea
                      className="w-full h-24 border border-gray-300 rounded p-2 mt-2 resize-none "
                      placeholder="Type your answer here..."
                    ></textarea>
                  ...
                  <div className="border rounded-lg shadow-lg p-4 mb-4 bg-white">
                    <h2 className="font-semibold mb-2"></h2>
                    <p>I persist through significant difficulties to achieve those goals. </p>
                    <textarea
                      className="w-full h-24 border border-gray-300 rounded p-2 mt-2 resize-none "
                      placeholder="Type your answer here..."
                    ></textarea>
                  ...
                  <div className="border rounded-lg shadow-lg p-4 mb-4 bg-white">
                    <h2 className="font-semibold mb-2">Initiative</h2>
                    <p>I anticipate needs, solve problems, and take action, all without explicit instructions. </p>
                    <textarea
                      className="w-full h-24 border border-gray-300 rounded p-2 mt-2 resize-none "
                      placeholder="Type your answer here..."
                    ></textarea>
                ...
                <div className="border rounded-lg shadow-lg p-4 mb-4 bg-white">
                    {/* <h2 className="font-semibold mb-2"></h2> */}
                    <p> I take the initiative to discover new work challenges and to help shape events that will lead to the organization’s success.</p>
                    <textarea
                      className="w-full h-24 border border-gray-300 rounded p-2 mt-2 resize-none "
                      placeholder="Type your answer here..."
                    ></textarea>
                  ...
                  <div className="border rounded-lg shadow-lg p-4 mb-4 bg-white">
                    ...
                    <p> I am committed to mproving my knowledge and skills.</p>
                    <textarea
                      className="w-full h-24 border border-gray-300 rounded p-2 mt-2 resize-none "
                      placeholder="Type your answer here..."
                    ></textarea>
                  ...
                  <div className="border rounded-lg shadow-lg p-4 mb-4 bg-white">
                    ...
                    <p> I am proactive in identifying areas for self-development. 
                    .</p>
                    <textarea
                      className="w-full h-24 border border-gray-300 rounded p-2 mt-2 resize-none "
                      placeholder="Type your answer here..."
